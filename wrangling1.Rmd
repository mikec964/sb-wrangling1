...
pcode <- as_tibble(str_split_fixed(pid, "-", 2)[,1])
names(pcode) <- "product code"
pnum <- as_tibble(str_split_fixed(pid, "-", 2)[,2])
names(pnum) <- "product name"
products.norm <- bind_cols(products.norm, pcode, pnum)
